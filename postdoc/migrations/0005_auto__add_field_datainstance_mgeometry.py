...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataInstance.mgeometry'
        db.add_column('postdoc_datainstance', 'mgeometry',
                      self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataInstance.mgeometry'
        db.delete_column('postdoc_datainstance', 'mgeometry')
