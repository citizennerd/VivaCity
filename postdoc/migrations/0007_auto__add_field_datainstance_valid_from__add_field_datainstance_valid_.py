...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataInstance.valid_from'
        db.add_column('postdoc_datainstance', 'valid_from',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 25, 0, 0)),
                      keep_default=False)

        # Adding field 'DataInstance.valid_to'
        db.add_column('postdoc_datainstance', 'valid_to',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataInstance.valid_from'
        db.delete_column('postdoc_datainstance', 'valid_from')

        # Deleting field 'DataInstance.valid_to'
        db.delete_column('postdoc_datainstance', 'valid_to')
    ...
    models = {
        'postdoc.datainstance': {
            ...
            'valid_to': ('django.db.models.fields.DateTimeField', [], {})
        },
