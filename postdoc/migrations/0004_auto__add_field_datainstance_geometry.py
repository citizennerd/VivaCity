...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataInstance.geometry'
        db.add_column('postdoc_datainstance', 'geometry',
                      self.gf('django.contrib.gis.db.models.fields.GeometryCollectionField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataInstance.geometry'
        db.delete_column('postdoc_datainstance', 'geometry')
