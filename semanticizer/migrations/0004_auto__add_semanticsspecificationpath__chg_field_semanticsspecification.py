...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SemanticsSpecificationPath'
        db.create_table('semanticizer_semanticsspecificationpath', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attribute', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postdoc.DataModelAttribute'])),
            ('next', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['semanticizer.SemanticsSpecificationPath'], null=True, blank=True)),
        ))
        db.send_create_signal('semanticizer', ['SemanticsSpecificationPath'])


        # Changing field 'SemanticsSpecification.via'
        db.alter_column('semanticizer_semanticsspecification', 'via_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['semanticizer.SemanticsSpecificationPath']))

    def backwards(self, orm):
        # Deleting model 'SemanticsSpecificationPath'
        db.delete_table('semanticizer_semanticsspecificationpath')


        # Changing field 'SemanticsSpecification.via'
        db.alter_column('semanticizer_semanticsspecification', 'via_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['postdoc.DataModelAttribute']))
    ...
    models = {
        ...
        'semanticizer.semanticsspecificationpath': {
            ...
            'attribute': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['postdoc.DataModelAttribute']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'next': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['semanticizer.SemanticsSpecificationPath']", 'null': 'True', 'blank': 'True'})
        }
    }
