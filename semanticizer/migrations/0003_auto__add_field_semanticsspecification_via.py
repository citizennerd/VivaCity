...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SemanticsSpecification.via'
        db.add_column('semanticizer_semanticsspecification', 'via',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='through_set', null=True, to=orm['postdoc.DataModelAttribute']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SemanticsSpecification.via'
        db.delete_column('semanticizer_semanticsspecification', 'via_id')
    ...
    models = {
        ...
        'semanticizer.semanticsspecification': {
            ...
            'via': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'through_set'", 'null': 'True', 'to': "orm['postdoc.DataModelAttribute']"})
        }
    }
